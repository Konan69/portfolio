...
function Image({ fill, priority: _priority, quality: _quality, className = "", ...props }: ImageProps) {
  return (
    <img
      {...props}
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
        ...
        {clientReady ? <HeroScene /> : null}

        <div className="relative z-10 w-full flex justify-center px-6">
          <h1
            className="font-display text-6xl md:text-8xl lg:text-9xl font-medium tracking-tighter leading-none text-[#f4efe4] transition-all duration-700 ease-out-quart gold-shimmer opacity-100 translate-y-0"
          >
