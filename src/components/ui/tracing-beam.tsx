...
export const TracingBeam = ({
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, (v) => Math.max(50, v * svgHeight - 200)),
    {
      stiffness: 500,
      damping: 90,
    },
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1 md:-left-20">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "white" : "#b8860b",
              borderColor: scrollYProgress.get() > 0 ? "white" : "#996e09",
            }}
        ...
        >
          <motion.path
            d={`M 1 0V -36 l 18 24 V ${svgHeight * 0.15} l -18 24V ${svgHeight}`}
            fill="none"
            stroke="#9091A0"
            strokeOpacity="0.16"
            transition={{
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.325" stopColor="#d4a017"></stop>
              <stop offset="1" stopColor="#b8860b" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
